...
plt.figure(figsize=(10, 10), dpi=160)
stations.plot_stations(verkehr, "Geo Point", label="vehicle couting stations", zorder=2, color="#ff5656", size=90, marker="s", edgecolors="white")
